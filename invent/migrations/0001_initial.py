    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='basedata.warehouse', verbose_name='warehouse')),
            ],
        ),
        migrations.CreateModel(
            name='StockOut',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.CharField(blank=True, max_length=20, null=True, verbose_name='batch')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organ.organization', verbose_name='organization')),
                ('po', models.ForeignKey(blank=True, limit_choices_to={'entry_status': '0'}, null=True, on_delete=django.db.models.deletion.CASCADE, to='purchase.purchaseorder', verbose_name='purchase order')),
